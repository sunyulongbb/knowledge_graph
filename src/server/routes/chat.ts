    ...
    for (const nodeId of matchedNodeIds) {
      ...
      ensureGraphNode(
        ...
        String(sourceRow.label_zh || sourceRow.name || sourceRow.id),
        {
          ...
          kind: "aligned",
          image:
            (Array.isArray(sourceRow.images) && sourceRow.images[0]) || "",
        ...
        for (const raw of values) {
          ...
          ensureGraphNode(
            ...
            String(targetRow.label_zh || targetRow.name || targetRow.id),
            {
              kind: "recommended",
              image:
                (Array.isArray(targetRow.images) && targetRow.images[0]) ||
                "",
      ...
      for (const attr of reverseAttrs) {
        ...
        ensureGraphNode(
          ...
          {
            kind: "recommended",
            image: (Array.isArray(source2.images) && source2.images[0]) || "",
            color: source2.color || "",
          },
        );
    ...
    if (centerRow) {
      ...
      nodes.push({
        data: {
          ...
          root: true,
          image:
            (Array.isArray(centerNode.images) && centerNode.images[0]) || "",
